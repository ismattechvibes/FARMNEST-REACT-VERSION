...
const Form = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    if (!password || !email || !Lastname || !Othername || !Phonenumber || !username || !role) {
      setShowError(true);
          ...
          <div className="logauth-input">
            <div>
              ...
              <div className="message">
                {showSuccess && (<div className="successMessage" style={{color: "green", border: "1px solid green"}}>{success}</div>)}
                {showError && (<div className="errorMessage" style={{color: "red", border: "1px solid red"}}>{error}</div>)}
              </div>
              <div className="form">
                <form onSubmit={active === "Login" ? handleLogin : handleSignUp}>
                  {active === "Sign Up" && (
